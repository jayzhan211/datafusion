...
pub use datafusion_physical_expr_common::functions::create_builtin_physical_expr;
pub use datafusion_physical_expr_common::functions::create_physical_fun;
pub use datafusion_physical_expr_common::functions::out_ordering;
...
mod tests {
    ...
    use datafusion_physical_expr_common::utils::test_utils::TestScalarUDF;
